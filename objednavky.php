    ...
    <div class="col-sm-12">
        ...
        switch($_SESSION["role"]) {
         ...
         $sql = "SELECT id_objednavky, ico, nazevZbozi, datum_nakup, datum_objednani, datum_kontroly, datum_platnosti, status, jmenoZakaznik, prijmeniZakaznik FROM objednavky, zbozi, zakaznici, zakoupene_zbozi
          WHERE zbozi.id_zbozi = zakoupene_zbozi.id_zbozi AND zakaznici.id_zakaznik = zakoupene_zbozi.id_zakaznik AND zakoupene_zbozi.id_zakoupene_zbozi = objednavky.id_zakoupene_zbozi AND zakoupene_zbozi.id_zakaznik = $id_zakaznik
          ...
          WHERE zbozi.id_zbozi = zakoupene_zbozi.id_zbozi AND zakaznici.id_zakaznik = zakoupene_zbozi.id_zakaznik AND zakoupene_zbozi.id_zakoupene_zbozi = objednavky.id_zakoupene_zbozi AND technici.id_technik = objednavky.id_technik AND objednavky.id_technik = $id_technik
          ORDER BY id_objednavky DESC";
                break;
            case "admin":
                $sql = "SELECT id_objednavky, ico, nazevZbozi, datum_nakup, datum_objednani, datum_kontroly, datum_platnosti, status, jmenoZakaznik, prijmeniZakaznik FROM objednavky, zbozi, zakaznici, zakoupene_zbozi
          WHERE zbozi.id_zbozi = zakoupene_zbozi.id_zbozi AND zakaznici.id_zakaznik = zakoupene_zbozi.id_zakaznik AND zakoupene_zbozi.id_zakoupene_zbozi = objednavky.id_zakoupene_zbozi
          ORDER BY id_objednavky DESC";
                break;
        }
